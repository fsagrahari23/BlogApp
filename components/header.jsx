...
const Header = ()=>{
  return(
    <div className="py-5 px-5 md:px-12 lg:28">
      ...
      <div className="text-center my-8">
        ...
        <p className="mt-10 max-w-[740px] m-auto text-xs sm:text-base">
          ...
          Sed euismod Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          Sed euismod Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p> 
        <form action="" className="inline-flex justify-between max-w-[500px] scale-75 sm:scale-100 mt-10 border border-black shadow-[-7px_7px_0px_#000000]">
